...
/***/ function(module, exports, __webpack_require__) {
	...
	var _configure_store = __webpack_require__(446);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _action = __webpack_require__(433);
	...
	var _AddProject = __webpack_require__(441);
	...
	var App = function (_Component) {
	    ...
	    _createClass(App, [{
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                'div',
	                { className: 'mod-project' },
	                _react2.default.createElement(_Nav2.default, { team: team }),
	                _react2.default.createElement(
	                    _row2.default,
	                    { gutter: 16 },
	                    ...
	                    _react2.default.createElement(
	                        _col2.default,
	                        { className: 'project-add gutter-row', span: 6, onClick: function onClick() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	function updateShow(updateShow, project) {
	  return {
	    type: UPDATE_SHOW,
	...
	function deleteShow(deleteShow, project) {
	  return {
	    type: DELETE_SHOW,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Project = function (_Component) {
	  ...
	  function Project(props, context) {
	    ...
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(Project).call(this, props, context));
	  }
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          { title: _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                'a',
	                { style: { float: 'right' }, href: '/project/' + project.id },
	                '详情'
	              )
	            ) },
	          _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              'a',
	              { className: 'ant-btn ant-btn-dashed', href: "/prd?projectId=" + project.id },
	              '进入PRD'
	            ),
	            ' ',
	            _react2.default.createElement(
	              ...
	              { type: 'primary', htmlType: 'submit', onClick: function onClick() {
	                  return actions.updateShow(true, project);
	                } },
	              '更新'
	            ),
	            ' ',
	            _react2.default.createElement(
	              _button2.default,
	              { type: 'danger', htmlType: 'submit', onClick: function onClick() {
	                  return actions.deleteShow(true, project);
	                } },
	              '删除'
	            )
	          )
	        ...
	        _react2.default.createElement(_AddProject2.default, {
	          ...
	          cancelCallback: function cancelCallback() {
	            return actions.updateShow(false, project);
	          },
	          okCallback: function okCallback(project) {
	            return actions.updateProject(project);
	          }
	        }),
	        _react2.default.createElement(
	          _modal2.default,
	          { title: '删除团队',
	            ...
	            onCancel: function onCancel() {
	              return actions.deleteShow(false, project);
	            },
	            onOk: function onOk() {
	              return actions.deleteProject(project);
	            }
	          },
	          _react2.default.createElement(
	            'p',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AddProject = function (_Component) {
	    ...
	    function AddProject(props, context) {
	        _classCallCheck(this, AddProject);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(AddProject).call(this, props, context));
	    }
	...
	AddProject = _form2.default.create()(AddProject);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function projects() {
	    ...
	    switch (action.type) {
	        ...
	        case _action.ADD:
	            return [action.project].concat(_toConsumableArray(state));
	        case _action.UPDATE:
	...
	function updateShow() {
	    var state = arguments.length <= 0 || arguments[0] === undefined ? { updateShow: false, project: {} } : arguments[0];
	    var action = arguments[1];
	...
	function deleteShow() {
	    var state = arguments.length <= 0 || arguments[0] === undefined ? { deleteShow: false, project: {} } : arguments[0];
	    var action = arguments[1];
